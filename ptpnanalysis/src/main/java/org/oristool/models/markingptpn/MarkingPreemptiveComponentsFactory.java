...
import org.oristool.models.ptpn.InitialPreemptiveStateBuilder;
...
public class MarkingPreemptiveComponentsFactory implements AnalyzerComponentsFactory<PetriNet, Transition> {

	private EnumerationPolicy policy;
    private MarkingPreemptiveSuccessionEvaluator markingPreemptiveSuccessionEvaluator;
    ...
    public MarkingPreemptiveComponentsFactory(){
    ...
    public MarkingPreemptiveComponentsFactory(
    	...
    	markingPreemptiveSuccessionEvaluator = new MarkingPreemptiveSuccessionEvaluator(
	...
	public SuccessionEvaluator<PetriNet, Transition> getSuccessionEvaluator() {
		return markingPreemptiveSuccessionEvaluator;
	}
