 ...
 */
@AutoValue
public abstract class PreemptiveAnalysis implements Engine<PetriNet, Marking, SuccessionGraph>{
    ...
    public abstract SamePrioStrategy samePrioStrategy();
    ...
    public abstract static class Builder {
        ...
        public abstract Builder samePrioStrategy(SamePrioStrategy sps);
        ...
        public Builder stopOn(MarkingCondition value) {
            Predicate<State> p = s -> value.evaluate(s.getFeature(PetriStateFeature.class).getMarking());
         ...
         */
        public abstract PreemptiveAnalysis build();
    ...
    public SuccessionGraph compute(PetriNet pn, Marking m) {
        ...
        PreemptiveComponentsFactory components = new PreemptiveComponentsFactory(true,
                excludeZeroProb(), true, policy().get(), stopOn().get(),
                monitor(), null, null, samePrioStrategy());
