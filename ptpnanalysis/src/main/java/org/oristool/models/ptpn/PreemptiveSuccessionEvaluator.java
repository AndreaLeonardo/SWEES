...
public class PreemptiveSuccessionEvaluator implements SuccessionEvaluator<PetriNet, Transition>{
	...
	public PreemptiveSuccessionEvaluator(MarkingUpdater tokensRemover, MarkingUpdater tokensAdder, boolean checkNewlyEnabled, boolean excludeZeroProb, SamePrioStrategy samePrioStrategy) {
