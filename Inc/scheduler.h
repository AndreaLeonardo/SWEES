...
#define schedUSE_SPORADIC_JOBS 1
	...
	#define schedMAX_NUMBER_OF_SPORADIC_JOBS 1000
...
#define schedUSE_TIMING_ERROR_DETECTION_EXECUTION_TIME 0
	...
	#define schedPOLLING_SERVER_PERIOD pdMS_TO_TICKS( 50 )
